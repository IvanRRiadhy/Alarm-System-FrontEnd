...
import { defaultScheduleFilter } from 'src/store/apps/defaultForm';
...
const ScheduleFilter = () => {
  ...
  const [appliedFilter, setAppliedFilter] = useState(scheduleFilter);

  // --- Sync with store ---
  useEffect(() => {
    setAppliedFilter(scheduleFilter);
  }, [scheduleFilter]);
  ...
  const handleApplyFilter = () => {
    dispatch(UpdateScheduleFilter({ ...appliedFilter, page: 1 }));
    setOpen(false);
  };

  const handleResetFilter = () => {
    setAppliedFilter(defaultScheduleFilter);
    dispatch(UpdateScheduleFilter({ ...defaultScheduleFilter }));
    setOpen(false);
  };
          ...
          <Grid container justifyContent="space-between">
            ...
            <Grid size={6}>
              <Button
                ...
                disabled={isEqual(appliedFilter, scheduleFilter)}
              >
                Apply
              </Button>
            </Grid>
